...
<style>
  .fullwidth.plain {
    background-color: #008CBA; /* Change this to your desired color */
    color: white;
  }
  .color-primary {
...
<span class="taipy-watermark" style="position:fixed;bottom:1em;opacity:0.4;color:gray;left:90%;transform:translateX(-50%);font-size:0.7em;">Devloped by Abhishek & team.</span>
